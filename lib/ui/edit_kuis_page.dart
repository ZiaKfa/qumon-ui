...
//   final int quizId; // ID soal yang akan diedit
...
//     });
//     try {
//       final quizData = await QuizBloc().getQuizById(widget.quizId);
//       final answerData = await AnswerBloc().getAnswerByQuizId(widget.quizId);

//       setState(() {
//         _selectedKategori = quizData['kategori_id'];
//         _soalController.text = quizData['soal'];
//         _jawabanController.text = answerData['jawaban'];
//         isLoading = false;
//       });
//     } catch (e) {
//       setState(() {
...
//       QuizBloc().updateQuiz(widget.quizId, userId, kategori, soal).then((value) {
//         AnswerBloc().updateAnswer(widget.quizId, jawaban).then((value) {
//           setState(() {
//             isLoading = false;
//           });
//           showDialog(
